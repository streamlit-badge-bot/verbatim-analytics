...
engtl_stop_words = []
for words in open(r'https://raw.githubusercontent.com/kcapalar/verbatim-analytics/main/resources/English-Tagalog%20Stopwords.txt', 'r'):
    engtl_stop_words.append(words.strip().lower())

with open(r'https://raw.githubusercontent.com/kcapalar/verbatim-analytics/main/resources/shortcuts_dict.txt', 'r') as s:
    data = s.read()
